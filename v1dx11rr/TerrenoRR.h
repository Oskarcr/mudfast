...
private:
	...
	ID3D11ShaderResourceView* terrainHeightMap;
...
public:
	TerrenoRR(int ancho, int alto, ID3D11Device* D3DDevice, ID3D11DeviceContext* D3DContext)
	{
		...
		CargaParametros(L"Textures/grass1.jpg", L"Textures/concrete2.jpg", L"Textures/dirt3.jpg", L"Textures/ColorMap.jpg", L"Textures/HeighmapPyc.jpg", 100.0f);
	}
	...
	bool CargaParametros(WCHAR* diffuseTex0, WCHAR* diffuseTex1, WCHAR* diffuseTex2, WCHAR* colormap, WCHAR* heightTex, float tile)
	{
		HRESULT d3dResult;
		...
		d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice, diffuseTex0, 0, 0, &colorMap, 0);
		d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice, L"Textures/grass1.jpg", 0, 0, &colorMap2, 0);
		d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice, L"Textures/concrete2.jpg", 0, 0, &colorMap3, 0);
		d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice, L"Textures/dirt3.jpg", 0, 0, &colorMap4, 0);
		d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice, L"Textures/ColorMap.jpg", 0, 0, &blendMap, 0);
		d3dResult = D3DX11CreateShaderResourceViewFromFile(d3dDevice, L"Textures/HeighmapPyc.jpg", 0, 0, &terrainHeightMap, 0);
	...
	void Draw(D3DXMATRIX vista, D3DXMATRIX proyeccion)
	{
		...
		d3dContext->PSSetShaderResources(3, 1, &colorMap4);
		d3dContext->PSSetShaderResources(4, 1, &blendMap);
		d3dContext->PSSetShaderResources(5, 1, &terrainHeightMap);
